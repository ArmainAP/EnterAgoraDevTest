...
void AEnterAgoraDevTestPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AEnterAgoraDevTestPawn::FireShot(FVector FireDirection)
{
	...
	if (bCanFire == true)
	{
		...
		if (FireDirection.SizeSquared() > 0.0f)
		{
			...
			bCanFire = false;
			World->GetTimerManager().SetTimer(TimerHandle_ShotTimerExpired, this, &AEnterAgoraDevTestPawn::ShotTimerExpired, FireRate);
...
void AEnterAgoraDevTestPawn::ShotTimerExpired()
{
	bCanFire = true;
}
